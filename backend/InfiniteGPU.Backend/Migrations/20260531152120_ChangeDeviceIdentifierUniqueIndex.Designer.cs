...
namespace InfiniteGPU.Backend.Migrations
{
    ...
    [Migration("20260531152120_ChangeDeviceIdentifierUniqueIndex")]
    partial class ChangeDeviceIdentifierUniqueIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InfiniteGPU.Backend.Data.Entities.Device", b =>
                {
                    ...
                    b.HasIndex("DeviceIdentifier", "ProviderUserId")
                        .IsUnique();

                    b.ToTable("Devices");
                });

            modelBuilder.Entity("InfiniteGPU.Backend.Data.Entities.DeviceModelCache", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DeviceId", "ModelUrl")
                        .IsUnique();

                    b.ToTable("DeviceModelCaches");
                });
            ...
            modelBuilder.Entity("InfiniteGPU.Backend.Data.Entities.Task", b =>
                {
                    ...
                    b.Property<string>("CheckpointBlobUri")
                        .HasMaxLength(2048)
                        .HasColumnType("nvarchar(2048)");
                    ...
                    b.Property<string>("EvalModelBlobUri")
                        .HasMaxLength(2048)
                        .HasColumnType("nvarchar(2048)");
                    ...
                    b.Property<string>("OptimizerModelBlobUri")
                        .HasMaxLength(2048)
                        .HasColumnType("nvarchar(2048)");
